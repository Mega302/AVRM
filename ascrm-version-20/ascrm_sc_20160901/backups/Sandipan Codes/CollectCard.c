...
int CollectCard_c(int Timeout)
{
        ...
        printf("\n[CollectCard_c()] Going to send Current Report status of st0, st1, st2");
        bcc = getBcc(9,g_getStatus);
        g_getStatus[8] = bcc;
        printf("\n[CollectCard_c()] bcc value is 0x%xh",bcc);
        ...
        for(i=0;i<9;i++)
	{
		 printf("\n[CollectCard_c()] Report Status Command[%d] = 0x%xh",i,g_getStatus[i]);
		 send_rvalue = SendSingleByteToSerialPort(h_commport,g_getStatus[i]);
                 if(0 == send_rvalue) 
                 {
                    printf("\n[CollectCard_c()] Failed to Send Report status Command ");
                    /* 1 = Communication Failure */
                    return 1;
                 }
	}

        printf("\n[CollectCard_c()] Status Command send Successfully");
        printf("\n[CollectCard_c()] Now Going to read Acknowledgement");
        ...
        printf("\n[CollectCard_c()] Receive packet status = %d and Length = %d",rtcode,rcvPktLen);
        if(0 == rtcode)
        {
                 /* 1 = Communication Failure */
                 ClearReceiveBuffer (h_commport);
	...
	{
		 printf("\n[CollectCard_c()] Acknowledgement against Report status Command [0] = 0x%xh.\n",rcvPkt[0]);
        ...
        if(0x06 == rcvPkt[0])
        {
                      printf("\n[CollectCard_c()] Acknowledgement Received");
                      totalByteToRecv = 12;
                      memset(rcvPkt,'\0',24);
                      ...
                      if(0 == rtcode)
		      {
				 ...
				 return 1;
	              ...
	              {
				printf("\n[CollectCard_c()] Report status Command Reply Data[%d] = 0x%xh",i,rcvPkt[i]);
                                /* Card Status Code st0 */
                                if(7 == i)
                                {
		                        if(0x30 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] No Card in MTK-571");
                                           /* 3 = No Card in the Channel */ 
                                           noCardInRF_IC = 1;
		                        }
                                        else if(0x31 == rcvPkt[i])
		                        {
                                           ...
                                           printf("\n[CollectCard_c()] One Card in Gate");
                                                                              
                  			 
                                        }
                                        else if(0x32 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] One Card on RF/IC Card Position");
		                        ...
		                        if(0x30 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] No Card in Stacker");
		                        }
                                        else if(0x31 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] Few Card in Stacker");
		                        }
                                        else if(0x32 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] Enough Card in the Box");
		                        }   
                                } 
		                        ...
		                        if(0x30 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] Error Card bin Not Full");
		                        }
                                        else if(0x31 == rcvPkt[i])
		                        {
                                           printf("\n[CollectCard_c()] Error Card Bin Full");
                                           /* 2 = Rejection Bin Full */ 
                                           rejectionBinFull = 1;
		                        }
                      ...
                      if(0 == send_rvalue) 
		      {
		            printf("\n[CollectCard_c()] Failed to send total Acknowledgement Command ");
                            /* 1 = Communication Failure */ 
                            return 1;
		      }
                      if(1 == noCardInRF_IC)
         ...
         {
             printf("\n[CollectCard_c()] Nak Reply Received");
             /* 5 = Other Error */
             return 5;  
         }
        ...
        printf("\n[CollectCard_c()] Going to send Reject Card Comamnd");
        ...
        for(i=0;i<9;i++)
	{
		 printf("\n[CollectCard_c()] Reject Card Command[%d] = 0x%xh",i,g_moveToErrorBin[i]);
		 send_rvalue = SendSingleByteToSerialPort(h_commport,g_moveToErrorBin[i]);
                 if(0 == send_rvalue) 
                 {
                    printf("\n[CollectCard_c()] Failed to Send Reject Card Command ");
                    /* 1 = Communication Failure */
                    return 1;
                 }
	}

        printf("\n[CollectCard_c()] Reject Card Command send Successfully");
        printf("\n[CollectCard_c()] Now Going to read Acknowledgement");
	...
	{
		 printf("\n[CollectCard_c()] Acknowledgement against Reject Card Command [0] = 0x%xh.\n",rcvPkt[0]);
