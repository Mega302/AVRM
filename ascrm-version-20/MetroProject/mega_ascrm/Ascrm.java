...
public class Ascrm extends javax.swing.JFrame implements Runnable 
{
     ...
     */
        ...
        public int fiveNotes,tenNotes,twentyNotes,fiftyNotes,hundredNotes,fiveHundredNotes,thousandNotes,totalNotes;
        public int fiveAmount,tenAmount,twentyAmount,fiftyAmount,hundredAmount,fiveHundredAmount,thousandAmount,totalAmount;
        int Time,denomTime;
        String sec;
        int Amount;
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void run()
        {
                ...
                byte[] acceptedNote1=new byte[100];
                int userAmount=0;
                String amount;
                ...
                int GetAcceptedAmount_rtcode=0;
                 ...
                 while(true)
                 {
                        ...
                        if(userAmount != previousAmount)
                        {
                                    ...
                                    textLog.insert("Rs. 100  X  "+hundredNotes+" = "+hundredAmount+"\t\tRs. 500  X  "+fiveHundredNotes+" = "+fiveHundredAmount+"\n", 0);
