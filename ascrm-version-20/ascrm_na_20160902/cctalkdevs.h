...
#define   CCTALK_REPLY_WAIT_TIME                 2      //++In Second malay add 29 march 2013
...
int GetReplyFromCCTalkPort   (unsigned char* const fncommand,unsigned char* const fnrecvpackt,unsigned int   fnrecvpacktLength,unsigned int*  const fnrecvlength,unsigned int   fnbytestoberead,int const CcTalkReplyWaitTime);
int GetReplyFromCCTalkPortV2 (unsigned char* const fncommand,unsigned char* const fnrecvpackt,unsigned int   fnrecvpacktLength,unsigned int*  const fnrecvlength,unsigned int   fnbytestoberead,int WaitBeforeReadReply,int const CcTalkReplyWaitTime);
...
int                   MONEYCONTROL_CoinAcptr_statusRead(unsigned char* const,unsigned int* const,int const,unsigned char* fnDeviceId);
