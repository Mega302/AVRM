 ...
 *
 * @par Recommendation:
 * As soon as the BNR is not used in a transaction, bnr_SelTest() should be 
 ...
 * @param[in]   userIdentification  The string to be written in the BNR; the maximum length is 255 characters.
 *
 * @return #BXR_NO_ERROR if successful or 
