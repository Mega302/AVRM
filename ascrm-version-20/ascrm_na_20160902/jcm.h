...
#define JCM_RETURN_TIME                     120       //SECONDS [Default:1hr]
...
#define JCM_STANDBY_WAIT_TIME                 1        //SECONDS [default: 5 min=  300 seconds]

#define JCM_SENSOR_OVER_WAIT_TIME             300      //SECONDS [default: 5 min= 300 seconds]

#define JCM_RETURN_WAIT_TIME                  2        //SECONDS [default:  2 seconds]
...
#define JCM_ROMVERSION_CMD              {JCM_DLE,JCM_STX,JCM_ROMVERSION,0xF0,0x00,JCM_DLE,JCM_ETX,0x00}    //8   Rom Version Code
...
//Check code for b2b
extern int g_StackAcceptedTime;

extern int g_ReturnAcceptedTime;

extern int g_NoteAcceptingFlag;
...
typedef struct NOTE {
   ...
   unsigned int INR_200:1;
   unsigned int INR_500:1;
   unsigned int INR_1000:1;
   unsigned int INR_2000:1;
...
typedef struct JCM_ESCROW_NOTE
{
   ...
   unsigned int AcceptedNumber_INR_200;
   unsigned int AcceptedNumber_INR_500;
   unsigned int AcceptedNumber_INR_1000;
   unsigned int AcceptedNumber_INR_2000;
}JCM_ESCROW_NOTE;
...
int JCM_Cmd_InsertionAuthorizedV2( unsigned char DefaultEnablebyte,
                                   unsigned char DefaultEnablebyte2,
