...
#define  B2B_WAIT_TIME_NOTE_ACPTR_FINISH_LOWLEVEL_THREAD    120  //(Second)  [Default: 2 Min ]
...
#define  WAIT_TIME_FOR_B2BREPLY          4    //In Second Fixed according to manual

#define  WAIT_TIME_FOR_UNLOADING         5       //In Second  

#define  WAIT_TIME_FOR_UNLOADED          30      //In Second  

#define  WAIT_TIME_FOR_DISPENSING        60      //In Second   default: 1 Minute
...
#define  CASHCODE_RES_DISPENSING_NOTE_IN_FRONOUTLET    0x01
//Malay
...
#define  WAIT_TIME_STACKED                10     // Second  
#define  WAIT_TIME_RETURNED               10     // Second  
...
int  B2B_GetValidNote(int Denom,int Timeout);
