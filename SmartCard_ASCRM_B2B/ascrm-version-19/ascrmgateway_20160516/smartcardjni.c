...
void SetSmartCardLog(const char *ObjectdllPath)
{
		...
		lib_handle = dlopen(ObjectdllPath,RTLD_NODELETE);
                                                                       ...
                                                                       )
{
	       ...
	       g_lib_handle=NULL;
               ...
               printf("\n[Java_Cris_SmartCard_JniSetupSmartCardLogFile()] dll path:%s",ObjectdllPath);
	       ...
	       printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log dll Path : %s", LogdllPathstr);
               ...
               {
                  printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log dll Path is NULL");
	       ...
	       //printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log File Name : %s", LogFileName);
               ...
               if(NULL == LogFileName )
               {
                  printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log file Path is NULL");
	       ...
	       ////////////////////////////////////////////////////////////////////////////////////////
               ...
               printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] LogMode Level: %d",g_LogModeLevel);
	       ...
	       //printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log dll Path : %s", deviceid);
               if(NULL == deviceid )
               {
                  printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] device id is NULL");
...

{
           ...
           if( 1 ==  rtcode )
           {
            ...
            else
            {
		         ...
		         //create new byte array
		         ReturnAPDUArray = (*env)->NewByteArray(env,2);
