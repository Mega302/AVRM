 ...
 *
 * This information is relevant mainly when the host systematically uses the command bnr_Denominate() with amount, 
...
typedef struct {
  ...
  T_Object        object;                       /**< Object that create this entry. */
...
typedef struct {
  ...
  T_Object        object;                                     /**< Inherited field from T_BillTransportLogEntryBaseClass. */
