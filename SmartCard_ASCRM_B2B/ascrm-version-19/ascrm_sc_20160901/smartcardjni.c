...
JNIEXPORT jboolean JNICALL Java_Cris_SmartCard_SetupSmartCardLogFile( JNIEnv  *env, 
                                                                      jclass  SmartCard,
                                                                      jstring jniLogfile, 
                                                                      jint    jniLogLevel, 
                                                                      jstring jniDeviceId,
                                                                    ...
                                                                    )
{
	       ...
	       printf("\n[Java_Cris_SmartCard_SetupSmartCardLogFile()] Log dll Path : %s", deviceid);
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_ConnectDevice( JNIEnv *env, 
                                                          jobject jobj, 
                                                          jint PortId, 
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_DisConnectDevice( JNIEnv *env, 
                                                             jobject jobj, 
                                                             jint Timeout
                                                           )
{
...
JNIEXPORT jbyteArray JNICALL Java_Cris_SmartCard_GetDeviceStatus( JNIEnv *env, 
                                                                  jobject jobj, 
                                                                  jint ComponentId, 
                                                                  jint Timeout
                                                                )
{
             ...
             writeFileLog("[Java_Cris_SmartCard_GetDeviceStatus()] Exit .");
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_AcceptCard( JNIEnv *env,  
                                                       jobject jobj, 
                                                       jint Timeout
                                                     )
{
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_DisableCardAcceptance( JNIEnv *env, 
                                                                  jobject jobj, 
                                                                  jint Timeout
                                                                )
{
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_EnableCardAcceptance( JNIEnv *env, 
                                                                 jobject jobj, 
                                                                 jint Timeout
                                                               )
{
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_IsCardInChannel(JNIEnv *env, jobject jobj, jint Timeout)
{
        ...
        writeFileLog("[Java_Cris_SmartCard_IsCardInChanne()] Entry");
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_SAMSlotPowerOnOff( JNIEnv *env, 
                                                              jobject jobj,
                                                              jint SAMSlotId,
...
JNIEXPORT jbyteArray JNICALL Java_Cris_SmartCard_ActivateCard( JNIEnv *env, 
                                                               jobject jobj, 
                                                               jint CardTechType,
                                                               jint SAMSlotId,
                                                               jint Timeout
...
JNIEXPORT jint JNICALL Java_Cris_SmartCard_DeactivateCard(  JNIEnv *env, 
                                                            jobject jobj, 
                                                            jint CardTechType,
                                                            jint SAMSlotId,
                                                            jint Timeout
...
JNIEXPORT jbyteArray JNICALL Java_Cris_SmartCard_XChangeAPDU( JNIEnv *env, 
                                                              jobject jobj, 
                                                              jint CardTechType, 
...
JNIEXPORT jbyteArray JNICALL Java_Cris_SmartCard_ResetSAM ( JNIEnv *env,
                                                            jobject jobj, 
                                                            jint SAMSlotId,
                                                            jint ResetType, 
                                                            jint Timeout
