        ...
        if( true == MUTEK_CommandTransmit(command,CommandLength) )
        {
		    ...
		    if( true ==  IsAckReceieve() )
		    {
		         ...
		         if ( true == MUTEK_CommandReceieve(RecvPackt,totalByteToRecv))
		         {
		                ...
		                //      ( 0x31 == RecvPackt[6] )     //PM
		                //    ) end
                                else if( ( 0x4e == RecvPackt[4] ) && ( 0x31 == RecvPackt[7] ) && ( 0x36 == RecvPackt[8] ) )
                                {
                                      writeFileLog("[CardBlockStatusRequest() Exit] Card blocked Found");
		                      return 1; //card not blocked      
		         ...
		         else //failure case
		         {
		            ...
		            {
		                 if( ( 0x4e == RecvPackt[4] ) && ( 0x31 == RecvPackt[7] ) && ( 0x36 == RecvPackt[8] ) )
		                 {
                                     writeFileLog("[CardBlockStatusRequest() Exit] Card Block Status Found");
                                     return 1;
		                 
		                 }//if( ( 0x4e == RecvPackt[4] ) && ( 0x4e == RecvPackt[4] ) && ( 0x4e == RecvPackt[4] ) )
                                 else
                                 {
                        ...
                        )
{
        ...
        for(i=0;i<9;i++)
	{
        ...
        if(0x06 == rcvPkt[0])
        {
                 ...
                 //printf("[DisableCardAcceptance()] Receive packet status = %d and Length = %d",rtcode,rcvPktLen);
                 ...
                 for(i=0;i<rcvPktLen;i++)
	         {
                 ...
                 */
                 ...
                 printf("\n [DisableCardAcceptance()]  Time = %d ",diffts.tv_sec);
		    ...
		    if( true ==  IsAckReceieve() )
		    {
		         ...
		         if ( true == MUTEK_CommandReceieve(RecvPackt,totalByteToRecv))
		         {
		                  ...
		                  )
		                {
					     ...
					     else if( (0x32 == RecvPackt[10] ) || (0x31 == RecvPackt[10] ) )
					     {
		         ...
		         else //failure case
		         {
		            ...
		            if( totalByteToRecv > 0 )
		            {
		                 if( 0x4e == RecvPackt[4] )
		                 {
                                     ...
                                     writeFileLog("[GetMTKeaderStatus() Exit] Negative ACK receieved.");                           
                                     return false;
		         ...
		         if ( true == MUTEK_CommandReceieve(RecvPackt,totalByteToRecv))
		         {
				     ...
				     writeFileLog("[GetMTKSensorStatus() Exit] Successfully get deactivate status from mutek.");                           
                                     ...
                                     *ChanelStatus=0;
                                     ...
                                     else if( ( 0x31 == RecvPackt[7] )||( 0x32 == RecvPackt[7] ) )//one card in chanel
                                     {
		         ...
		         else //failure case
		         {
		            ...
		            if( totalByteToRecv > 0 )
		            {
		                 if( 0x4e == RecvPackt[4] )
		                 {
                                     ...
                                     writeFileLog("[GetMTKSensorStatus() Exit] Negative ACK receieved.");                           
                                     return false;
                  ...
                  )
{
	      ...
	      memset(MTKStatus,0,6);
              ...
              if( 1 == CardBlockStatusRequest ( LogdllPathstr,LogFileName,deviceid,fnLogfileMode) )
              {
                       ReplyDeviceStatus[0] = 2; //Force Card detection error
        ...
        if(0x06 == rcvPkt[0])
        {
		      ...
		      //BCC  (1 byte) : bc
                      ...
                      if( (rcvPktLen> 0) && ( 0x4e == rcvPkt[4] ) )
                      {
                          ...
                          if( (0x31==rcvPkt[7]) && ( 0x36 == rcvPkt[8] ) ) 
                          {
                                writeFileLog("[IsCardInChannel_c() Exit] Insertion/return mouth blocked");
                                return 4; //Insertion mouth blocked
                          }
                          else
                          {
...
int IsCardRemoved_c(int Timeout,char *LogdllPathstr,
                     char *LogFileName,
                     char *deviceid,
                     int fnLogfileMode)
{
        ...
        if(0x06 == rcvPkt[0])
        {
		      ...
		      //BCC  (1 byte) : bc
                      ...
                      if( (rcvPktLen> 0) && ( 0x4e == rcvPkt[4] ) )
                      {
                          ...
                          if( (0x31==rcvPkt[7]) && ( 0x36 == rcvPkt[8] ) ) 
                          {
                                writeFileLog("[IsCardRemoved_c() Exit] Insertion/return mouth blocked");
                                return 4; //Insertion mouth blocked
                          }
                          else
                          {
        ...
        if(0x06 == rcvPkt[0])
        {
                      ...
                      if(0 == rtcode)
		      {
				 ...
				 return 1;
		              ...
		              //Force Card Detection
		              if( ( 0x4e == rcvPkt[4] ) && ( 0x31 == rcvPkt[7] ) && ( 0x36 == rcvPkt[8] ) )
			      {
		                       ...
		                       {
                                               writeFileLog("[CollectCard_c()] Operation failed to Block card did collect successfully.");
		                               return 5; //Other Error
                      ...
                      if(0 == rtcode)
		      {
				 ...
				 return 1;
                     ...
                     ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		              ...
		              //Force Card Detection
		              if( ( 0x4e == rcvPkt[4] ) && ( 0x31 == rcvPkt[7] ) && 
                                  ( 0x36 == rcvPkt[8] ) )
			      {
		              ...
		              )
		            {
		                ...
		                //)  
		                  ...
		                  )
                            {
                                      ...
                                      writeFileLog("[DispenseCard_c()] 0x4e receieved Other error");
        ...
        else  if(0x06 == rcvPkt[0]) //ack byte receieved
	{
                 ...
                 if(0 == rtcode)
		 {
		      ...
		      return 1;
                 ...
                 if(0 == send_rvalue) 
		 {
		       writeFileLog("[ReturnCard_c()] Failed to send Acknowledgement byte for reject command .");
                      ...
                      if(0 == rtcode)
		      {
				 ...
				 return 1;
		                  ...
		                  ( 0x36 == rcvPkt[8] ) )
			      {
		                         ...
		                         if( 1 == MutekInitWithCardMoveInFront( LogdllPathstr,LogFileName,deviceid,fnLogfileMode) )
		                         {
                              ...
                              {
                                  writeFileLog("[ReturnCard_c()] Negative response receieved .");
                                  return 5;//other error
